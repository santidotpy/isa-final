package com.ar.edu.um.santiago.library.service.criteria;
...
/**
 * Criteria class for the {@link com.ar.edu.um.santiago.library.domain.Author} entity. This class is used
 * in {@link com.ar.edu.um.santiago.library.web.rest.AuthorResource} to receive all the possible filtering options from
...
public class AuthorCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, bookId, distinct);
    }
